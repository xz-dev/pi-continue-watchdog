...
4. `pi-extension-utils` owns only authenticated ZeroMQ transport, peer status, directed/broadcast data, and Pi lifecycle facts. This watchdog owns participant activity, certainty, revisions, activity generations, fences, grace, retries, and decision queues.
